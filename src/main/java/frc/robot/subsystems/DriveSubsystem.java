...
public class DriveSubsystem extends Subsystem {
  ...
  public void periodic() {
    SmartDashboard.putNumber("gyro", m_gyro.getAngle()-gyroOffset);
    // Update the odometry in the periodic block
    SmartDashboard.putNumber("frontleft-drive", m_frontLeft.getPosition().distanceMeters);
    m_odometry.update(
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
    ...
    var swerveModuleStates = DriveConstants.kDriveKinematics.toSwerveModuleStates(
        fieldRelative
            ? ChassisSpeeds.fromFieldRelativeSpeeds(xSpeedDelivered, ySpeedDelivered, rotDelivered, Rotation2d.fromDegrees(m_gyro.getAngle()-gyroOffset))
...
m_rearRight.setDesiredState(swerveModuleStates[3]);
  ...
  public double getHeading() {
    return Rotation2d.fromDegrees(m_gyro.getAngle()-gyroOffset).getDegrees();
  }
